...
<link rel="stylesheet" type="text/css" media="screen" href="{{asset('feka/css/bootstrap.css')}}">
<link rel="stylesheet" href="{{asset('feka/css/font-awesome.css')}}">
<link rel="stylesheet" href="{{asset('feka/css/animate.css')}}">
<link rel="stylesheet" href="{{asset('feka/css/styles.css')}}">
			...
			<div id="grid-gallery" class="grid-gallery">
					...
					<section class="grid-wrap">
						<ul class="grid">
							...
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img1.jpg')}}" alt=""/>
									<figcaption><h3>Thundercats level</h3> </figcaption>
								</figure>
							</li>
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img2.jpg')}}" alt=""/>
									<figcaption><h3>Bushwick selvage</h3></figcaption>
								</figure>
							</li>
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img3.jpg')}}" alt=""/>
							...
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img5.jpg')}}" alt=""/>
									<figcaption><h3>Vice velit chia</h3></figcaption>
								</figure>
							</li>
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img6.jpg')}}" alt=""/>
							...
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img7.jpg')}}" alt=""/>
									<figcaption><h3>Brunch semiotics</h3></figcaption>
								</figure>
							</li>
							...
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img8.jpg')}}" alt=""/>
									<figcaption><h3>Brunch semiotics</h3></figcaption>
								</figure>
							</li>
					...
					<section class="slideshow">
						<ul>
							...
							<li>
								<figure>
									<img src="{{asset('feka/img/gallery/img4.jpg')}}" alt=""/>
...
<!--Javascripts-->
<script src="{{asset('feka/js/jquery.js')}}"></script>
<script src="{{asset('feka/js/modernizr.js')}}"></script>
<script src="{{asset('feka/js/bootstrap.js')}}"></script>
<script src="{{asset('feka/js/jquery-scrolltofixed.js')}}"></script>
<script src="{{asset('feka/js/jquery.nav.js')}}"></script> 
<script src="{{asset('feka/js/jquery.easing.1.3.js')}}"></script>
<script src="{{asset('feka/js/menustick.js')}}"></script> 
<script src="{{asset('feka/js/easing.js')}}"></script>
<script src="{{asset('feka/js/wow.js')}}"></script>
<script src="{{asset('feka/js/smoothscroll.js')}}"></script>
<script src="{{asset('feka/js/masonry.js')}}"></script>
<script src="{{asset('feka/js/imgloaded.js')}}"></script>
<script src="{{asset('feka/js/classie.js')}}"></script>
<script src="{{asset('feka/js/colorfinder.js')}}"></script>
<script src="{{asset('feka/js/gridscroll.js')}}"></script>
<script src="{{asset('feka/js/contact.js')}}"></script>
<script src="{{asset('feka/js/custom.js')}}"></script>
